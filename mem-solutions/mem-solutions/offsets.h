namespace O {
	namespace BaseNetworkable {
		...
		constexpr auto get_JustCreated = 0x3AB290;
		constexpr auto set_JustCreated = 0x3AB330;
		constexpr auto ClientSpawn = 0x7876E0;
		constexpr auto ClientOnEnable = 0x787650;
		constexpr auto ClientInit = 0x787440;
		constexpr auto OnNetworkUpdate = 0x788A70;
		constexpr auto PreNetworkUpdate = 0x393010;
		constexpr auto PostNetworkUpdate = 0x393010;
		constexpr auto ShouldDestroyWithGroup = 0x392E10;
		constexpr auto ShouldDestroyImmediately = 0x4B6F10;
		constexpr auto NetworkDestroy = 0x7884C0;
		constexpr auto DoClientDestroy = 0x787A80;
		constexpr auto DoNetworkDestroy = 0x393010;
		constexpr auto BroadcastOnPostNetworkUpdate = 0x7871F0;
		constexpr auto PostProcess = 0x788C00;
		constexpr auto GetParentEntity = 0x787DE0;
		constexpr auto HasParent = 0x787DF0;
		constexpr auto AddChild = 0x787150;
		constexpr auto RemoveChild = 0x788C90;
		constexpr auto get_gameManager = 0x789100;
		constexpr auto get_prefabAttribute = 0x789150;
		constexpr auto get_IsDestroyed = 0x3B5B10;
		constexpr auto set_IsDestroyed = 0x3B5DE0;
		constexpr auto get_PrefabName = 0x789020;
		constexpr auto get_ShortPrefabName = 0x789060;
		constexpr auto GetNetworkPosition = 0x634BE0;
		constexpr auto GetNetworkRotation = 0x787DA0;
		constexpr auto InvokeString = 0x787E00;
		constexpr auto LookupPrefab = 0x788410;
		constexpr auto EqualNetID = 0x787D50;
		constexpr auto ResetState = 0x788D00;
		constexpr auto InitShared = 0x393010;
		constexpr auto PreInitShared = 0x393010;
		constexpr auto PostInitShared = 0x393010;
		constexpr auto DestroyShared = 0x393010;
		constexpr auto OnNetworkGroupEnter = 0x393010;
		constexpr auto OnNetworkGroupLeave = 0x393010;
		constexpr auto OnNetworkGroupChange = 0x788920;
		constexpr auto OnNetworkSubscribersEnter = 0x393010;
		constexpr auto OnNetworkSubscribersLeave = 0x393010;
		constexpr auto EntityDestroy = 0x787C70;
		constexpr auto DoEntityDestroy = 0x787B30;
		constexpr auto SpawnShared = 0x788D70;
		constexpr auto Load = 0x788070;
		constexpr auto get_isServer = 0x4B6F10;
		constexpr auto get_isClient = 0x392E10;
		constexpr auto OnRpcMessage = 0x4B6F10;
		constexpr auto ctor = 0x788F50;
		constexpr auto cctor = 0x788E60;
	};

	namespace BasePlayer {
		constexpr auto __menuOption_Climb = 0x260;
		constexpr auto __menuOption_Drink = 0x2D0;
		constexpr auto __menuOption_InviteToTeam = 0x3B0;
		constexpr auto __menuOption_Menu_AssistPlayer = 0x420;
		constexpr auto __menuOption_Menu_LootPlayer = 0x490;
		constexpr auto __menuOption_Promote = 0x500;
		constexpr auto __menuOption_SaltWater = 0x570;
		...
		constexpr auto playerModel = 0x5E8;
		constexpr auto Frozen = 0x5F0;
		constexpr auto voiceRecorder = 0x5F8;
		constexpr auto voiceSpeaker = 0x600;
		...
		constexpr auto lastReceivedTeamTime = 0x718;
		constexpr auto lastPresenceTeamId = 0x720;
		constexpr auto lastPresenceTeamSize = 0x728;
		constexpr auto playerGroupKey = 0x730;
		constexpr auto playerGroupSizeKey = 0x738;
		constexpr auto clActiveItem = 0x740;
		constexpr auto ClientCurrentMapNote = 0x748;
		constexpr auto ClientCurrentDeathNote = 0x750;
		constexpr auto modelState = 0x770;
		constexpr auto mounted = 0x778;
		constexpr auto nextSeatSwapTime = 0x788;
		constexpr auto cachedBuildingPrivilegeTime = 0x7B8;
		constexpr auto cachedBuildingPrivilege = 0x7C0;
		constexpr auto maxProjectileID = 0x7D0;
		constexpr auto lastUpdateTime = 0x7D4;
		constexpr auto cachedThreatLevel = 0x7D8;
		constexpr auto serverTickRate = 0x7DC;
		constexpr auto clientTickRate = 0x7E0;
		constexpr auto serverTickInterval = 0x7E4;
		constexpr auto clientTickInterval = 0x7E8;
		constexpr auto lastSentTickTime = 0x7EC;
		constexpr auto lastSentTick = 0x7F8;
		constexpr auto nextVisThink = 0x800;
		constexpr auto lastTimeSeen = 0x804;
		constexpr auto debugPrevVisible = 0x808;
		constexpr auto fallDamageEffect = 0x810;
		constexpr auto drownEffect = 0x818;
		constexpr auto playerFlags = 0x820;
		constexpr auto eyes = 0x828;
		constexpr auto inventory = 0x830;
		constexpr auto blueprints = 0x838;
		constexpr auto metabolism = 0x840;
		constexpr auto input = 0x608;
		constexpr auto movement = 0x610;
		constexpr auto collision = 0x618;
		constexpr auto Belt = 0x858;
		constexpr auto triggerCollider = 0x850;
		constexpr auto physicsRigidbody = 0x860;
		constexpr auto userID = 0x868;
		constexpr auto UserIDString = 0x870;
		constexpr auto _displayName = 0x880;
		constexpr auto _lastSetName = 0x888;
		constexpr auto cachedProtection = 0x8E0;
		constexpr auto oldCameraFix = 0x180;
		constexpr auto lastHeadshotSoundTime = 0x8E8;
		constexpr auto clothingBlocksAiming = 0x8F0;
		constexpr auto clothingMoveSpeedReduction = 0x8F4;
		constexpr auto clothingWaterSpeedBonus = 0x8F8;
		constexpr auto clothingAccuracyBonus = 0x8FC;
		constexpr auto equippingBlocked = 0x900;
		constexpr auto eggVision = 0x904;

		constexpr auto GetMenuOptions = 0x7CA470;
		constexpr auto get_HasMenuOptions = 0x7EA740;
		constexpr auto OnRpcMessage = 0x7D4480;
		constexpr auto HandleCCTVRenderRequest = 0x2deb90;
		constexpr auto SetPlayerModelVisible = 0x86D650;
		constexpr auto CanBeLooted = 0x7BE840;
		constexpr auto Menu_LootPlayer = 0x7D3070;
		constexpr auto Menu_LootPlayer_ShowIf = 0x7D3050;
		constexpr auto RPC_OpenLootPanel = 0x7E11B0;
		constexpr auto PlayOpenSound = 0x7DF300;
		constexpr auto InFirstPersonMode = 0x7CDE00;
		constexpr auto UpdateViewMode = 0x7E7B30;
